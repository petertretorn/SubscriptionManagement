...
namespace SubscriptionManagement.Infrastructure.Migrations
{
    ...
    [Migration("20210313165842_changed field name")]
            ...
            modelBuilder.Entity("SubscriptionManagement.Domain.Entities.Customer", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            Id = new Guid("c79ebb0b-d6fb-41fd-b110-ad2b722f2345"),
            ...
            modelBuilder.Entity("SubscriptionManagement.Domain.Entities.Subscription", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            Id = new Guid("6552414a-b8db-48f5-9640-f6be68d492d5"),
                            AutomaticallyReneweble = true,
                            CustomerId = new Guid("c79ebb0b-d6fb-41fd-b110-ad2b722f2345"),
                            HasDefaulted = false,
            ...
            modelBuilder.Entity("SubscriptionManagement.Domain.Entities.Subscription", b =>
                {
                    ...
                    b.OwnsOne("SubscriptionManagement.Domain.Entities.SubscriptionType", "Type", b1 =>
                        {
                            ...
                            b1.HasData(
                                new
                                {
                                    SubscriptionId = new Guid("6552414a-b8db-48f5-9640-f6be68d492d5"),
                                    Description = "some description",
                                    Level = 4,
                                    PeriodInDays = 365,
                                    ProductId = new Guid("0f6873b5-766c-4852-8db3-2a363c483830")
                                });
                        });
