...
I didn't get around to make a client library calling the api, but since it is an api service it is a question of programmatically issuing HTTP request. In C# that could be done using HttpClient factory, example for POST request:
